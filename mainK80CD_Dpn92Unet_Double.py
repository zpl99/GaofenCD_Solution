...
def train_cd(input_file, configs):
    ...
    model = xModel.Dpn92_Unet_Double(pretrained=False).cuda()
    ...
    lr_schedule = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, 10, eta_min=0.00001, last_epoch=-1)
    max_epochs = 100
...
if __name__ == '__main__':
    ...
    configs = "configs/lzp_configs_cd_Dpn92Unet_Double"
