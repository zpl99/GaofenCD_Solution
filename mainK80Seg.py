...
def train_seg(input_file, configs):
    train_set = GaofenDataset.NormalImgDataset(input_file, train_transform, label_norm=1)
    ...
    model = deeplab_resnet.DeepLabv3_plus().cuda()
...
if __name__ == '__main__':
    ...
    configs = "configs/lzp_configs_seg"
